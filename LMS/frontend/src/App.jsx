  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="main-content">
        ...
        {activeMenu === 'courses' && <PagePlaceholder pageName="Courses Management" />}
        {activeMenu === 'reports' && <PagePlaceholder pageName="Reports & Analytics" />}
        {activeMenu === 'schedule' && <PagePlaceholder pageName="Schedule & Calendar" />}
        {activeMenu === 'documents' && <PagePlaceholder pageName="Documents Library" />}
        {activeMenu === 'notifications' && <PagePlaceholder pageName="Notifications Center" />}
        {activeMenu === 'settings' && <PagePlaceholder pageName="System Settings" />}
      </div>
    </div>
  );
}
